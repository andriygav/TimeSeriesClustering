...
\begin{frame}{Синтетические данные}
	\begin{figure}[h!t]\center
		\subfloat[Synthetic 1]{\includegraphics[width=0.5\textwidth]{results/2_patern_claster_vector}}
		\subfloat[Synthetic 2]{\includegraphics[width=0.5\textwidth]{results/3_patern_claster_vector}}\\
