...
\begin{table}[h]
	\begin{center}
	\caption{Описание временных рядов используемых в эксперименте}
		\begin{tabular}{|c|c|c|c|}
		\hline
			Название& N& K& T\\
			\hline
			\multicolumn{1}{|l|}{Physical Motion 1}& 900& 2& 20\\
			\hline
			\multicolumn{1}{|l|}{Physical Motion 2}& 1000& 2& 20\\
			\hline
			\multicolumn{1}{|l|}{Synthetic 1}& 2000& 2& 20\\
			\hline
			\multicolumn{1}{|l|}{Synthetic 2}& 2000& 3& 20\\
		\hline
		\end{tabular}
	\end{center}
\end{table}
