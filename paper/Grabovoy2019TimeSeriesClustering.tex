...
\end{comment}
\title{\bfЛОКАЛЬНАЯ КЛАСТЕРИЗАЦИЯ ВРЕМЕННЫХ РЯДОВ\thanks{Работа выполнена при поддержке РФФИ и правительства РФ.}}
\date{}
\author{}
\maketitle
...
\begin{itemize}
    ...
    \item Максимальный период $\text{T}$ сигналов известен.\\
    ...
    \item Известно количество $\text{K}$ различных сигналов.\\
