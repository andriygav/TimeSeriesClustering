...
\subsection{Фазовое пространство, построенное при помощи LSTM}
\begin{figure}[h!t]\center
\subfloat[$sin(x)$]{\includegraphics[width=0.5\textwidth]{figures/TimeSeries4.pdf}}
\subfloat[$sin(x)$]{\includegraphics[width=0.5\textwidth]{figures/PhaseSpace4.pdf}}\\

\caption{Результаты для модели с рис.~\ref{fig1} без декодера}
\label{fig4}
\end{figure}

Как видно на рис.~\ref{fig4} в случае, когда размерность скрытого пространства $2$, то получаем, что LSTM строит такое же пространство, как и Настя при помощи SVD разложения.
